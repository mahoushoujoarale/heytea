<template>
  ...
  <div id="pay">
    ...
    <div class="third">
      ...
      <div class="third_fourth">共计{{$store.getters.getSum}}件商品，小计 <span>¥ {{$store.getters.getAllPrice}}</span></div>
    </div>
    <div class="fourth">
      <div>选择地址</div>
      <img src="/src/assets/imgs/address/edit.png" alt="" @click="$router.push('/selectaddress')" >
    </div>
    <div class="fifth">
      <div>支付方式</div>
      <span>支付宝</span>
